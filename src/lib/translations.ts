export const translations: Record<string, any> = {
  ...
  DE: {
    ...
    cannotPublish: "Auktion kann nicht veröffentlicht werden",
    connectBankAccountDesc: "Um eine Auktion zu veröffentlichen, müssen Sie zuerst Ihr Bankkonto für Auszahlungen verknüpfen.",
    editPayouts: "Zahlungen & Auszahlungen verwalten",
    myBidsDesc: "Übersicht über alle Ihre Auktionsgebote",
    condition: "Zustand",
    ...
    tabPersonalData: "Persönliche Daten",
    tabPaymentsPayouts: "Zahlungen & Auszahlungen",
    annualPurchaseLimitTitle: "Jährliches Einkaufslimit (EU-Gesetzgebung / AML)",
    annualLimitVerified: "Ihr Profil ist verifiziert. Einkaufen ist unbegrenzt.",
    annualLimitUnverified: "Benutzer können ohne zusätzliche Verifizierung bis zu 10.000 € an Einkäufen pro Kalenderjahr tätigen.",
    spendingInYear: "Ausgaben im Jahr",
    personalDataVerificationNotice: "Ihre persönlichen Daten werden angezeigt, sobald Sie Ihr Profil im oberen Reiter verifizieren.",
    country: "Land",
    phoneNumber: "Telefonnummer",
    autoInvoiceGeneration: "Automatische Rechnungserstellung für Provisionen",
    walletFunds: "Kontoguthaben (Wallet)",
    walletDesc: "Guthaben aus erfolgreich verkauften Auktionen, das Sie für Einkäufe verwenden oder zur Auszahlung anfordern können.",
    currentBalance: "Aktueller Kontostand",
    requestPayout: "Auszahlung anfordern",
    insufficientFunds: "Unzureichendes Guthaben für eine Auszahlung.",
    connectStripeForPayout: "Bitte verbinden Sie ein Stripe-Bankkonto für Auszahlungen.",
    payoutRequestSuccess: "Auszahlungsantrag gesendet! Das Guthaben wird auf Ihr verknüpftes Konto überwiesen.",
    stripeBankConnection: "Bankkontoverbindung (Stripe)",
    stripeBankConnectionDesc: "Verknüpfen Sie Ihr Bankkonto, um Auszahlungen aus verkauften Auktionen zu erhalten und Ihre Überweisungsdaten zu verwalten.",
    stripeAccountAndPayouts: "Stripe-Konto & Auszahlungen",
    stripeVerificationAndPayouts: "Stripe-Verifizierung & Auszahlungen",
    stripeConnectedDesc: "Ihr Konto ist verknüpft. Sie können Ihre Bankdaten und Auszahlungseinstellungen einsehen und aktualisieren.",
    stripeUnconnectedDesc: "Um Auktionen zu veröffentlichen und Gelder zu erhalten, müssen Sie ein Bankkonto verifizieren und verknüpfen. Die Überprüfung erfolgt sicher über Stripe.",
    manageBankAccount: "Bankkonto verwalten",
    startVerification: "Verifizierung starten",
    increaseBid: "Gebot erhöhen",
...
export const getCategoryTranslation = (cat: string | null | undefined, t: (key: string) => string): string => {
  if (!cat) return '';
