export const translations: Record<string, any> = {
  SLO: {
    ...
    basicDesc: "Za aktivne prodajalce. Objavite lahko do 20 dražb vsak mesec in prihranite pri prodaji z znižano 6.5% provizijo na uspešne transakcije.",
  ...
  EN: {
    ...
    basicDesc: "Up to 20 posts/month, 6.5% fee",
  ...
  DE: {
    ...
    basicDesc: "Bis zu 20 Beiträge/Monat, 6.5% Gebühr",
